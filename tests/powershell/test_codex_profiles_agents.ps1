...
foreach ($expected in @(
    ...
    '$CodexDeepProfileModel',
    '$CodexMcpDefaultDisabledServers',
...
foreach ($expected in @(
    ...
    'codex_lean_profile_verbosity: low',
    'codex_deep_profile_model: gpt-5.6-sol',
    'codex_deep_profile_reasoning_effort: high',
    'codex_deep_profile_verbosity: medium',
